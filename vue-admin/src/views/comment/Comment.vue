...
import {query, tableData, list, label, confirmDelete, isDelete, deleteById, total,handlePageNum,handlePageSize} from "../../api/comment.ts";
...
<template>
  <el-card>
    <el-row :gutter="20">
      <el-col :span="7">
        <el-input placeholder="搜索框" clearable v-model="query.content" @input="list"/>
      </el-col>
